    ...
    <div class="payment">
    	<table border="0px" cellpadding="0px" cellspacing="0px" width="100%">
            ...
            <tr>
                ...
                <td class="prd-price" style="color:red"><?php echo $row['gia_sp'] ?>đ</td>
                <td class="prd-number"><?php echo $_SESSION['giohang'][$row['id_sp']] ?></td>
                <td class="prd-total" style="color:red"><?php echo $totalPrice ?>đ</td>
            </tr>
             <?php
            ...
            <tr>
                ...
                <td colspan="2"></td>
                <td class="prd-total" style="color:red"><span><?php echo $totalPriceAll ?>đ</span></td>
            </tr>
        </table>
